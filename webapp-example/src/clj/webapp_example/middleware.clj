(ns webapp-example.middleware
  (:require [webapp-example.env :refer [defaults]]
            [cheshire.generate :as cheshire]
            [cognitect.transit :as transit]
            [clojure.tools.logging :as log]
            [webapp-example.layout :refer [*app-context* error-page]]
            ...
            [webapp-example.config :refer [env]]
